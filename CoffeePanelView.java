...
public class CoffeePanelView extends JPanel {
	...
	public CoffeePanelView() {
		...
		// Add Listeners
		noCoffee.addActionListener(control.coffee);
		regularCoffee.addActionListener(control.coffee);
		decafCoffee.addActionListener(control.coffee);
		cappuccino.addActionListener(control.coffee);
	}
